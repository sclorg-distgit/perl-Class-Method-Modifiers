%{?scl:%scl_package perl-Class-Method-Modifiers}
...
Name:           %{?scl_prefix}perl-Class-Method-Modifiers
...
BuildRequires:  %{?scl_prefix}perl(Moose)
%endif
# Runtime
...
%changelog
* Mon Jan 06 2020 Jitka Plesnikova <jplesnik@redhat.com> - 2.13-2
- SCL
...
- %%doc is now supported in EPEL too
